      ...
      <div class="hero-content">
        ...
        <div class="hero-features">
          <div class="feature-item">
            ...
            <span>{{ t('home.features.professionalDoctors') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
          ...
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.features.privacyProtection') }}</span>
          </div>
        </div>
    ...
    <section class="statistics">
      <div class="stat-card">
        ...
        <div class="stat-info">
          ...
          <p>{{ t('home.statistics.professionalDoctors') }}</p>
        </div>
      </div>
      <div class="stat-card">
      ...
      <div class="stat-card">
        ...
        <div class="stat-info">
          ...
          <p>{{ t('home.statistics.pendingQuestions') }}</p>
        </div>
      </div>
      <div class="stat-card">
      ...
      <div class="rooms-grid">
        ...
        >
          <div class="room-header">
            ...
            <a-badge status="processing" :text="t('common.online')" />
          </div>
          <div class="room-body">
            <h3>{{ doctor.name }}</h3>
